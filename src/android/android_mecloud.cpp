...
jbyteArray jsonByteArray(JNIEnv *env, jobject thiz);
jbyteArray byteArrayValue(JNIEnv *env, jobject jo, jstring jkey);
...
jobjectArray stringByteArrayValue(JNIEnv *env, jobject jo, jstring jkey);

void jputString(JNIEnv *env, jobject jo, jstring jkey, jbyteArray jvalue);
...
void whereEqualToString(JNIEnv *env, jobject thiz, jstring jkey, jbyteArray jval);
...
void whereEqualOr(JNIEnv *env, jobject thiz, jstring jkey, jbyteArray jvalue);
void whereEqualOrToInt(JNIEnv *env, jobject thiz, jstring jkey, jint jvalue);
void whereGreaterToString(JNIEnv *env, jobject thiz, jstring jkey, jbyteArray jvalue);
void whereGreaterToInt(JNIEnv *env, jobject thiz, jstring jkey, jint jvalue);
void whereLessToString(JNIEnv *env, jobject thiz, jstring jkey, jbyteArray jvalue);
...
jbyteArray cryptoStringByte(JNIEnv *env, jobject thiz, jbyteArray byteArray);
jbyteArray decrypt(JNIEnv *env, jobject thiz, jbyteArray byteArray);
jbyteArray decryptStringByte(JNIEnv *env, jobject thiz, jbyteArray byteArray);
...
void deleteObject(JNIEnv *env, jobject thiz, jobject jJsonObject, jobject jcallback);
...
void matchEqualTo(JNIEnv *env, jobject thiz, jstring key, jbyteArray value);
void matchEqualToInt(JNIEnv *env, jobject thiz, jstring jkey, jint value);
void matchGreater(JNIEnv *env, jobject thiz, jstring jkey, jbyteArray value);
void matchGreaterToInt(JNIEnv *env, jobject thiz, jstring jkey, jint value);
void matchLess(JNIEnv *env, jobject thiz, jstring key, jbyteArray value);
...
void whereEqualToWithAggregate(JNIEnv *env, jobject thiz, jstring jkey, jbyteArray jvalue);
void whereEqualToIntWithAggregate(JNIEnv *env, jobject thiz, jstring jkey, jint jvalue);
void whereNotEqualToWithAggregate(JNIEnv *env, jobject thiz, jstring jkey, jbyteArray jvalue);
void whereNotEqualToIntWithAggregate(JNIEnv *env, jobject thiz, jstring jkey, jint jvalue);
void whereGreaterWithAggregate(JNIEnv *env, jobject thiz, jstring jkey, jbyteArray jvalue);
void whereGreaterIntWithAggregate(JNIEnv *env, jobject thiz, jstring jkey, jint jvalue);
void whereLessWithAggregate(JNIEnv *env, jobject thiz, jstring jkey, jbyteArray jvalue);
...
jbyteArray jsonByteArray(JNIEnv *env, jobject thiz) {
    ...
    env->SetByteArrayRegion(byteArray, 0, len, reinterpret_cast<const jbyte*>(string));
    return byteArray;
}
...
jbyteArray byteArrayValue(JNIEnv *env, jobject jo, jstring jkey) {
    ...
    jbyteArray byteArray = env->NewByteArray(len);
    env->SetByteArrayRegion(byteArray, 0, len, reinterpret_cast<const jbyte*>(value));
    env->ReleaseStringUTFChars(jkey, key);
    return byteArray;
}
...
jobjectArray stringByteArrayValue(JNIEnv *env, jobject jo, jstring jkey) {
    ...
    for (int i = 0; i < size; ++i) {
        const char *value = jsonArray.stringValue(i);
        int len = strlen(value);
        jbyteArray byteArray = env->NewByteArray(len);
        env->SetByteArrayRegion(byteArray, 0, len, reinterpret_cast<const jbyte*>(value));
        (env)->SetObjectArrayElement(args, i, byteArray);
    }
    env->ReleaseStringUTFChars(jkey, key);
    return args;
}
...
void jputString(JNIEnv *env, jobject jo, jstring jkey, jbyteArray jvalue) {
    const char *key = env->GetStringUTFChars(jkey, NULL);
    jbyte *value = (jbyte *)env->GetByteArrayElements(jvalue, 0);
...
void whereEqualToString(JNIEnv *env, jobject thiz, jstring jkey, jbyteArray jvalue) {
    const char *key = env->GetStringUTFChars(jkey, NULL);
    jbyte *value = (jbyte *)env->GetByteArrayElements(jvalue, 0);
    int len = env->GetArrayLength(jvalue);
    char *string = new char[len + 1];
...
void whereNotEqualToString(JNIEnv *env, jobject thiz, jstring jkey,
    ...
    string[len] = '\0';
    MeQuery *obj = (MeQuery *) env->GetLongField(thiz, g_ptr);
    obj->whereNotEqualTo(key, string);
    env->ReleaseStringUTFChars(jkey, key);
    delete string;
    env->ReleaseByteArrayElements(jvalue, value, 0);
}
...
void selectKeys(JNIEnv *env, jobject thiz, jobjectArray jkeys, jint num) {
    ...
    for (int i = 0; i < size; ++i) {
        ...
        env->ReleaseStringUTFChars(tempString, key);
    }
    MeQuery *obj = (MeQuery *) env->GetLongField(thiz, g_ptr);
...
jbyteArray cryptoStringByte(JNIEnv *env, jobject thiz, jbyteArray byteArray) {
    jsize size = env->GetArrayLength(byteArray);
    char *data = (char *) env->GetPrimitiveArrayCritical(byteArray, NULL);
    char *cryptoData = MeCloud::shareInstance()->crypto(data, size);
    env->ReleasePrimitiveArrayCritical(byteArray, data, NULL);
    jbyteArray jarray = env->NewByteArray(size);
    env->SetByteArrayRegion(jarray, 0, size, (jbyte *) cryptoData);
    free(cryptoData);
...
jbyteArray decryptStringByte(JNIEnv *env, jobject thiz, jbyteArray byteArray) {
    jsize size = env->GetArrayLength(byteArray);
    char *data = (char *) env->GetPrimitiveArrayCritical(byteArray, NULL);
    char *decryptData = MeCloud::shareInstance()->decrypt(data, size);
    env->ReleasePrimitiveArrayCritical(byteArray, data, NULL);
    jbyteArray jarray = env->NewByteArray(size);
    env->SetByteArrayRegion(jarray, 0, size, (jbyte *) decryptData);
    free(decryptData);
...
void matchEqualTo(JNIEnv *env, jobject thiz, jstring jkey, jbyteArray jvalue) {
    const char *key = env->GetStringUTFChars(jkey, NULL);
    jbyte *value = (jbyte *)env->GetByteArrayElements(jvalue, 0);
    int len = env->GetArrayLength(jvalue);
    char *string = new char[len + 1];
...
void matchGreater(JNIEnv *env, jobject thiz, jstring jkey, jbyteArray jvalue) {
    const char *key = env->GetStringUTFChars(jkey, NULL);
    jbyte *value = (jbyte *)env->GetByteArrayElements(jvalue, 0);
    int len = env->GetArrayLength(jvalue);
    char *string = new char[len + 1];
...
void matchLess(JNIEnv *env, jobject thiz, jstring jkey, jbyteArray jvalue) {
    const char *key = env->GetStringUTFChars(jkey, NULL);
    jbyte *value = (jbyte *)env->GetByteArrayElements(jvalue, 0);
    int len = env->GetArrayLength(jvalue);
    char *string = new char[len + 1];
